        ...
        <div class="grid lg:grid-cols-2 gap-12">
            <div>
                <div class="space-y-6">
                    ...
                    <a href="mailto:kabodgrua@gmail.com" class="flex items-center gap-4 group p-4 border border-[#1f1f1f] rounded-xl hover:border-primary transition-colors">
                        <div class="h-14 w-14 rounded-full flex items-center justify-center text-primary group-hover:bg-primary group-hover:text-black transition-colors" style="background:rgba(250,204,21,0.1)">
                        ...
                        <div>
                            ...
                            <span class="font-bold text-xl group-hover:text-primary transition-colors">kabodgrua@gmail.com</span>
                        </div>
                    </a>
