    ...
    <div class="container-custom py-8">
        ...
        <div class="flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <div class="flex flex-col gap-3">
                <a href="mailto:kabodgrua@gmail.com" class="flex items-center gap-3 text-gray-300 hover:text-primary transition-colors">
                    ...
                    <span class="font-medium">kabodgrua@gmail.com</span>
                </a>
